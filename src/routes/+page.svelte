...
<main class="p-2 text-wrap text-center bg-white dark:bg-neutral-900">
        ...
        <div class="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
            ...
            <div class="max-w-lg lg:mx-12 lg:order-2">
				<h2 class="text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">
					pouchdocs Record Time Documentation <span class="text-primary">Sites</span>
				</h2>
				<p class="mt-4 text-gray-500 dark:text-gray-300">
					launch documentation sites fast,connect with supabase and you are ready to ship 
				</p>
				<div class="mt-6">
                    <a href="/docs" class="px-6 py-2.5 mt-6 text-sm font-medium leading-5 text-center text-white capitalize bg-primary rounded-full hover:bg-emerald-500 lg:mx-0 lg:w-auto focus:outline-none">getstarted</a>
                </div>
            </div>
        </div>

        <div class="flex items-center justify-center rounded w-full h-96 lg:w-1/2">
			<video src="/pouchdocs.mp4" class="rounded" width="100%" height="100%" autoplay muted controls >

			</video>
        </div>
    </div>
	<div class="flex flex-row items-center content-center gap-2 mb-4 flex-wrap">
		<div hidden >
			ad
		</div>
	</div>
	...
	<section class="">
		<div class="container px-6 py-10 mx-auto">
			<h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">explore our <br> awesome <span class="text-primary">fearures</span></h1>
			...
			<div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2">
				...
				<div class="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
					<div class="md:flex md:items-start md:-mx-4">
						...
						<div class="mt-4 md:mx-4 md:mt-0">
							<h1 class="text-xl font-medium text-gray-700 capitalize dark:text-white">One click Host CDN </h1>
	
							<p class="mt-3 text-gray-500 dark:text-gray-300">
								works out of the box with :
								<a href="https://netlify.com" class="text-primary" >netlify</a>
								<a href="https://vercel.com" class="text-primary"  >vercel</a>
							</p>
						</div>
					</div>
				</div>
	...
	<footer class="">
		<div class="container px-6 py-8 mx-auto">
			...
			<div class="flex flex-col items-center sm:flex-row sm:justify-between">
				...
				<div class="flex -mx-2">
					<a href="https://www.reddit.com/user/pouchlabs/" class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Reddit">
					...
					<a href="https://github.com/pouchlabs/pouchdocs" class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
						<svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
							xmlns="http://www.w3.org/2000/svg">
							<path
